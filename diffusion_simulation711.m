function diffusion_simulation711(num_nuclei, num_steps, cell_length, diffusion_coefficient)
    ...
    for t=2:num_steps
        ...
        positions(positions>cell_length) = cell_length-(positions(positions>cell_length)-cell_length);
